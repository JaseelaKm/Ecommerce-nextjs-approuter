      ...
      <nav className="navbar navbar-expand-lg bg-danger-subtle">
        <div className="container-fluid">
          <Link className="navbar-brand pe-5 fw-bold" href="/">
            <img src="/logoimg.jpeg" alt="Logo" width={90} height={40} />
          </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <SearchBox />
            <Link href="/Cart" className="btn btn-outline-dark position-relative ms-2">
              <img src='/cart icon.png' alt="Cart Icon" width={20} height={25} />
              {cartItems.length > 0 && (
