        ...
        <div className="d-flex flex-column align-items-center">
          <div className="row w-100 ">
            <div className="col-6 col-md-3 mb-4 customLink">
              <Link
                href={"/Category/books/cat_aZWNoy0dEw80JA"}
            ...
            <div className="col-6 col-md-3 mb-4 customLink">
              <Link
                href={"/Category/groceries/cat_BkyN5YxO9o0b69"}
                className="category-link "
              >
                <div className="text-center">
                  <Image
            ...
            <div className="col-6 col-md-3 mb-4,customLink">
              <Link
                href={"/Category/kids-fashion/cat_31q0o3jO4wDdjR"}
                className="category-link "
              >
                <div className="text-center">
                  <Image
            ...
            <div className="col-6 col-md-3 mb-4,customLink">
              <Link
                href={"/Category/electronics/cat_p6dP5grL9on7kA"}
                className="category-link "
              >
                <div className="text-center">
                  <Image
